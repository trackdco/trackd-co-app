#!/bin/sh
# Launch the dev server in the DEFAULT state: no billing gate, no reminder promise.
# This is the state the tree is left in.
...
unset BILLING_GATE_ENABLED
unset REMINDER_PROMISE_ENABLED
