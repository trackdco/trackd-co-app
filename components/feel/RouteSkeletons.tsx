...
function CompoundCardSk() {
  return (
    <div className="flex w-[150px] shrink-0 flex-col items-center gap-3 rounded-2xl bg-bg-surface px-3.5 py-5">
  ...
  return (
    <>
      ...
      <div>
        ...
        <section className="mt-3 rounded-2xl bg-bg-surface p-5">
          <ScheduleRowSk />
          <ScheduleRowSk />
          <ScheduleRowSk />
          <ScheduleRowSk />
...
function MetricCardSk({ graph }: { graph?: number }) {
  return (
    <section className="flex flex-col rounded-2xl bg-bg-surface p-4">
      <Sk w="56%" h={9} />
  ...
  return (
    <>
      ...
      <div>
        ...
        <section className="mt-3 divide-y divide-border-default rounded-2xl bg-bg-surface">
          <ProfileRowSk />
          <ProfileRowSk />
          <ProfileRowSk />
          <ProfileRowSk />
  ...
  return (
    <>
      {Array.from({ length: cards }, (_, i) => (
        <section key={i} className="rounded-2xl bg-bg-surface p-5">
          <Sk w="96px" h={9} />
          <Sk w="70%" h={14} className="mt-4" />
