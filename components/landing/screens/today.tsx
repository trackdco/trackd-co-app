 ...
 * around.
 *
 * ⚠️ Generic labels ("Peptide A"), never a real compound, on a page an Apple
 * reviewer reads (Adrian, 2026-09-16). No score, streak or percentage anywhere.
 */
    ...
    <div className="space-y-5 px-5 pt-4">
      ...
      <section className="rounded-2xl bg-bg-surface p-5">
        ...
        <div className="mt-4">
          <Group cat="peptide" label="Peptides">
            <Row name="Peptide A" detail="250mcg · 7:30 AM" logged />
            <DueRow name="Peptide B" detail="500mcg · 8:00 AM" />
          </Group>
          <Group cat="anabolic" label="Anabolics" settled>
            <Row name="Injectable A" detail="250mg · 8:10 AM" logged />
          </Group>
          <Group cat="supplement" label="Supplements" settled>
            <Row name="Supplement A" detail="5g · 8:15 AM" logged />
          </Group>
        </div>
      </section>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <section className="flex flex-col items-center rounded-2xl bg-bg-surface p-5 text-center">
          ...
          <p className="mt-2 text-sm text-foreground">Peptide A</p>
