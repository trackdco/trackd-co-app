...
export function VialGlyph() {
  return (
    <svg width="22" height="30" viewBox="0 0 20 34" aria-hidden focusable="false">
...
export function SyringeGlyph() {
  return (
    <svg width="42" height="29" viewBox="0 0 44 24" aria-hidden focusable="false">
...
export function SparkGlyph() {
  return (
    <svg width="42" height="27" viewBox="0 0 44 20" aria-hidden focusable="false">
      <defs>
...
export function BellGlyph() {
  return (
    <svg width="25" height="29" viewBox="0 0 24 28" aria-hidden focusable="false">
