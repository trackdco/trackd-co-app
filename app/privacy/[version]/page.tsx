...
/**
 * A SUPERSEDED VERSION OF THIS DOCUMENT, AT A STABLE URL — /privacy/1.3.
 *
 ...
 *
 * ⚠️ THIS DOES NOT DECIDE WHAT IS CURRENT. /privacy keeps that job and is
...
export default async function PrivacyVersionPage({
  ...
  const { version } = await params;
  return <LegalDocument docType="privacy_policy" version={version} />;
}
