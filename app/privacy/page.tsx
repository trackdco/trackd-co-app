...
/**
 * Placeholder. The real privacy copy (drafted by the founders) drops in here
...
export default function PrivacyPage() {
  return (
    <div className="mx-auto flex min-h-screen max-w-2xl flex-col px-6 py-16">
      ...
      <h1 className="mt-12 font-display text-3xl text-foreground">Privacy Policy</h1>
      <p className="mt-4 text-sm leading-relaxed text-text-muted">
        Our full privacy policy is being finalised and will appear here before launch.
      </p>
      <Link
        href="/"
