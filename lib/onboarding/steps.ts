...
export function stepAppliesTo(id: StepId, platform: Platform): boolean {
  ...
  // desktop browsers grant web push perfectly well, and that screen asks in
  // place rather than deferring the way iOS has to.
  if (id === "install") return platform !== "desktop";
  return true;
}
