 ...
 */
/**
 * REAL NAMES, AFTER THE AGE GATE (Adrian, 2026-08-05: "get rid of Sample
 * Compound").
 *
 * A cold reviewer walking the flow as a customer put it best: "you've verified
 * my age, you've got my consent tick, and you're STILL saying Compound 1.
 * That's what makes me suspect nobody on the team runs anything."
 *
 * The rule this does NOT break: the HOOK still names nothing. That screen runs
 * BEFORE the age gate and is a public marketing surface, which is a stricter
 * line than the spec draws and is Adrian's standing call. `notes-compare.tsx`
 * stays generic and must not be "tidied" to match this.
 *
 * Nothing here is a recommendation. The demo shows a dose being LOGGED, states
 * no amount as advice, and the screens around it carry no dosing guidance.
 */
